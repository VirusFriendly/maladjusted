...
0x8057579:		jne    0x8057580 // jump if 0x8078b18 != 0
...
0x8048184:		push   $0xffffffff
0x8048186:		call   0x8055fbc

0x8055fbc:			push   %ebp
0x8055fbd:			mov    %esp,%ebp
0x8055fbf:			push   %edi
0x8055fc0:			push   %esi
0x8055fc1:			push   %ebx
0x8055fc2:			mov    0x8078af4,%edi
0x8055fc8:			test   %edi,%edi
0x8055fca:			je     0x805601d
0x8055fcc:			mov    0x4(%edi),%ebx
x8055fcf:			mov    %ebx,%eax
0x8055fd1:			dec    %ebx
0x8055fd2:			test   %eax,%eax
0x8055fd4:			je     0x8056017 //---
0x8055fd6:			lea    (%ebx,%ebx,2),%eax
0x8055fd9:			lea    0x8(,%eax,4),%esi
0x8055fe0:			lea    (%esi,%edi,1),%edx
0x8055fe3:			mov    (%edx),%eax
0x8055fe5:			cmp    $0x1,%eax
0x8055fe8:			je     0x8055ff4
0x8055fea:			jb     0x805600d
0x8055fec:			cmp    $0x2,%eax
0x8055fef:			je     0x8056008
0x8056008:			mov    0x4(%edx),%eax
0x805600b:			call   *%eax

0x80675d0:				call   0x8048110

0x8048110:					push   %ebx
0x8048111:					mov    $0x80792b8,%ebx
0x8048116:					cmpl   $0x0,0x80792b8
0x804811d:					je     0x804812c
0x804812c:					pop    %ebx
0x804812d:					ret    

0x80675d5:				ret    $0x0

0x805600d:			mov    %ebx,%eax
0x805600f:			add    $0xfffffff4,%esi
0x8056012:			dec    %ebx
0x8056013:			test   %eax,%eax
0x8056015:			jne    0x8055fe0 //---
0x8056017:			mov    (%edi),%edi
0x8056019:			test   %edi,%edi
0x805601b:			jne    0x8055fcc
0x805601d:			call   0x8062188

0x8062188:				push   %ebp
0x8062189:				mov    %esp,%ebp
0x806218b:				push   %esi
0x806218c:				push   %ebx
0x806218d:				xor    %esi,%esi
0x806218f:				mov    0x80787f8,%ebx
0x8062195:				test   %ebx,%ebx
0x8062197:				je     0x80621c3
0x8062199:				lea    0x0(%esi),%esi
0x806219c:				mov    0x14(%ebx),%eax
0x806219f:				cmp    %eax,0x10(%ebx)
0x80621a2:				jae    0x80621bc
0x80621bc:				mov    0x34(%ebx),%ebx
0x80621bf:				test   %ebx,%ebx
0x80621c1:				jne    0x806219c
0x806219c:				mov    0x14(%ebx),%eax
0x806219f:				cmp    %eax,0x10(%ebx)
0x80621a2:				jae    0x80621bc
0x80621bc:				mov    0x34(%ebx),%ebx
...
0x80621bf:				test   %ebx,%ebx
0x80621c1:				jne    0x806219c
0x80621c3:				mov    %esi,%eax
0x80621c5:				lea    0xfffffff8(%ebp),%esp
0x80621c8:				pop    %ebx
0x80621c9:				pop    %esi
0x80621ca:				mov    %ebp,%esp
0x80621cc:				pop    %ebp
0x80621cd:				ret    

0x8056022:			mov    0x8(%ebp),%ecx
0x8056025:			push   %ecx
0x8056026:			call   0x8057554

0x8057554:				push   %ebp
0x8057555:				mov    %esp,%ebp
0x8057557:				push   %ebx
0x8057558:				mov    $0x1,%eax
0x805755d:				mov    0x8(%ebp),%ebx
0x8057560:				int    $0x80
